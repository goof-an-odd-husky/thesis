...
\thesistitle{Ground Onboard Outdoor Footpath Autonomous Navigation, Obstacle Detection and Dodging using Husky}
...
\author{Radomyr \textsc{Husiev}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\emph{Author:}\\
\href{https://r1a.nl}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
