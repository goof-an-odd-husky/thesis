...
The problem is solved using the Dense Normal Cholesky linear solver via \texttt{pyceres}. Due to Python limitations (% TODO: cite GIL
), performance drops when increasing the number of threads, so the optimization is strictly restricted to a single thread. To maintain a predictable control rate, the solver is capped at a strict maximum number of iterations. % TODO: explain, why Dense Cholesky
...
% TODO: write the remaining sections of proposed solution
