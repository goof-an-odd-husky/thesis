...
\begin{itemize}
    ...
    \item There are dynamic, non-cooperative entities -- primarily pedestrians, bicycles, and pets -- whose unpredictable trajectories test the responsiveness real-time collision avoidance capabilities of the system.
\end{itemize}
